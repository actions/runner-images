### General
The virtual-environment project uses packer tool and contains templates for the following OSs: Windows 2016/2019, Ubuntu 16.04/18.04/20.04. 
...
- `TemplatFilePath` - The path to the json template generated by packer during image generation locally.
