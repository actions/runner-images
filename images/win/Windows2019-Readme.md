...
- Pipx 1.1.0
- RubyGems 2.7.6.3
- Vcpkg (build from master \<6f7ffeb18>)
- Yarn 1.22.19
...
- 3.1.120 3.1.202 3.1.302 3.1.425 5.0.104 5.0.214 5.0.303 5.0.408 5.0.414

### .NET Core Runtime
`Location: C:\Program Files\dotnet\shared\Microsoft.AspNetCore.App`
- 3.1.4 3.1.6 3.1.20 3.1.31 5.0.4 5.0.9 5.0.17 6.0.11
