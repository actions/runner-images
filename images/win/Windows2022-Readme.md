...
- Pipx 1.2.0
- RubyGems 3.2.33
- Vcpkg (build from commit b51f391cd)
- Yarn 1.22.19
...
- Microsoft Edge Driver 111.0.1661.43
...
| Name                          | Version        | Path                                                     |
| ----------------------------- | -------------- | -------------------------------------------------------- |
| Visual Studio Enterprise 2022 | 17.5.33502.453 | C:\Program Files\Microsoft Visual Studio\2022\Enterprise |
