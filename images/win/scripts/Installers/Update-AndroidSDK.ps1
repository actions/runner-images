...
Extract-7Zip -Path $sdkArchPath -DestinationPath android-sdk
...
Extract-7Zip -Path .\android-sdk-licenses.zip -DestinationPath $sdk_root -Force
...
Push-Location -Path (Get-Item -Path .\android-sdk).FullName
