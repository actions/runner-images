...
***
# macOS 11
- OS Version: macOS 11.7.5 (20G1225)
- Kernel Version: Darwin 20.6.0
- Image Version: 20230328.2
...
- Pipx 1.2.0
- RubyGems 3.4.10
- Vcpkg 2023 (build from commit 1271068e1)
- Yarn 1.22.19
...
### Browsers
- Safari 16.4 (16615.1.26.101.9)
- SafariDriver 16.4 (16615.1.26.101.9)
...
| nginx | 1.23.4  | /usr/local/etc/nginx/nginx.conf | none          | 80         |
