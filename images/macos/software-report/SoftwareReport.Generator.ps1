...
$languageAndRuntime.AddToolVersionsInlineList(".NET Core SDK", $(Get-DotnetVersionList), '^\d+\.\d+\.\d')
...
$languageAndRuntime.AddToolVersionsInlineList("NVM - Cached node versions", $(Get-NVMNodeVersionList), '^\d+')
