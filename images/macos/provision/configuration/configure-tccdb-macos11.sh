...
configure_tccdb "/Library/Application Support/com.apple.TCC/TCC.db" "${systemValuesArray[@]}"
...
configure_tccdb "$HOME/Library/Application Support/com.apple.TCC/TCC.db" "${userValuesArray[@]}"
