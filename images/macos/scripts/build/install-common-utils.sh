...
for package in $common_packages; do
    ...
    if is_Monterey && [[ $package == "xcbeautify" ]]; then
        ...
        xcbeautify_path=$(download_with_retry "https://github.com/Homebrew/homebrew-core/blob/d3653e83f9c029a3fddb828ac804b07ac32f7b3b/Formula/x/xcbeautify.rb")
        brew_smart_install "$xcbeautify_path"
    else
