...
- Image Version: 20220207.2

## Installed Software
### Language and Runtime
- .NET SDK 3.1.101 3.1.201 3.1.302 3.1.416 5.0.102 5.0.202 5.0.302 5.0.404
...
- Pipx 1.0.0
- RubyGems 3.2.33
- Vcpkg 2022 (build from master \<7a6855abe>)
- Yarn 1.22.17
...
- SafariDriver 15.3 (17612.4.9.1.5)
...
| 1.17.6 (Default) | x64          | GOROOT_1_17_X64      |
...
| Version          | Build    | Path                           |
| ---------------- | -------- | ------------------------------ |
| 13.3 (beta)      | 13E5086k | /Applications/Xcode_13.3.app   |
