...
# Ubuntu 16.04.7 LTS
The following software is installed on machines with the 20200823.1 update.
***
- 7-Zip 9.20
...
- AWS CLI (aws-cli/1.18.124 Python/2.7.12 Linux/4.15.0-1092-azure botocore/1.17.47)
...
Homebrew/linuxbrew-core (git revision 15f34; last commit 2020-08-23))
