...
# Ubuntu 16.04.6 LTS
The following software is installed on machines with the 20200525.2 update.
***
- Homebrew on Linux (Homebrew 2.2.17
Homebrew/linuxbrew-core (git revision 44bb4d; last commit 2020-05-25))
- 7-Zip 9.20
...
- AWS CLI (aws-cli/1.18.66 Python/2.7.12 Linux/4.15.0-1082-azure botocore/1.16.16)
- build-essential
- nvm (0.35.3)
- Clang 6.0 (6.0.0)
- Clang 8 (8.0.0)
...
- .NET Core SDK:
  ...
  - 2.1.301
  - 2.1.300
- Erlang (Erlang (SMP,ASYNC_THREADS,HIPE) (BEAM) emulator version 11.0.1)
...
- Zeit Now CLI (19.0.1)
- MongoDB on Linux (2020-05-25T13:08:54.422+0000 I  CONTROL  [initandlisten] db version v4.2.7
2020-05-25T13:08:54.422+0000 I  CONTROL  [initandlisten] git version: 51d9fe12b5d19720e72dcd7db0f2f17dd9a19212
2020-05-25T13:08:54.422+0000 I  CONTROL  [initandlisten] OpenSSL version: OpenSSL 1.0.2g  1 Mar 2016)
- Haveged 1.9.1-3
- AWS SAM CLI, version 0.51.0
