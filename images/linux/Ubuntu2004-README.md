...
- AWS CLI (aws-cli/2.0.36 Python/3.7.3 Linux/5.4.0-1022-azure exe/x86_64.ubuntu.20)
...
- MySQL (mysql  Ver 8.0.21-0ubuntu0.20.04.3 for Linux on x86_64 ((Ubuntu)))
...
- pip (pip 20.2 from /usr/local/lib/python2.7/dist-packages/pip (python 2.7))
...
Homebrew/linuxbrew-core (git revision 31f4d; last commit 2020-08-02))
