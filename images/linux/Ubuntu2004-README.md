...
# Ubuntu 20.04 LTS
The following software is installed on machines with the 20200607.1 update.
***
- Homebrew on Linux (Homebrew 2.3.0
Homebrew/linuxbrew-core (git revision 4d542; last commit 2020-06-06))
- 7-Zip 16.02
...
- AWS CLI (aws-cli/1.18.74 Python/2.7.18rc1 Linux/5.4.0-1012-azure botocore/1.16.24)
- build-essential
- Clang 6.0 (6.0.1)
- Clang 8 (8.0.1)
- Clang 9 (9.0.1)
