...
# Ubuntu 18.04.4 LTS
The following software is installed on machines with the 20200705.1 update.
***
- Homebrew on Linux (Homebrew 2.4.3
Homebrew/linuxbrew-core (git revision 9eb30; last commit 2020-07-05))
- 7-Zip 16.02
...
- AWS CLI (aws-cli/1.18.93 Python/2.7.17 Linux/5.3.0-1031-azure botocore/1.17.16)
- build-essential
- Clang 6.0 (6.0.0)
- Clang 8 (8.0.0)
- Clang 9 (9.0.0)
...
- Heroku (heroku/7.42.2 linux-x64 node-v12.16.2)
- HHVM (HipHop VM 4.64.0 (rel))
- ImageMagick
- Azul Zulu OpenJDK:
...
- Vercel CLI (19.1.1)
- MongoDB on Linux (2020-07-05T08:49:05.254+0000 I  CONTROL  [initandlisten] db version v4.2.8
2020-07-05T08:49:05.254+0000 I  CONTROL  [initandlisten] git version: 43d25964249164d76d5e04dd6cf38f6111e21f5f
2020-07-05T08:49:05.254+0000 I  CONTROL  [initandlisten] OpenSSL version: OpenSSL 1.1.1g  21 Apr 2020)
- Haveged 1.9.1-6
